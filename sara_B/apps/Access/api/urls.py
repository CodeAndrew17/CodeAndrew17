...
from apps.Access.api.views import GeneralCrear_listar,General_eliminar_modificiar,RegistrarUsuarios,EmpleadosUsuarios
...
urlpatterns=[
    ...
    path('empleados_api/',EmpleadosUsuarios.as_view()),
]